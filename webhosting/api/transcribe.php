...
$apiKey = defined('YANDEX_SPEECHKIT_API_KEY') ? (string) YANDEX_SPEECHKIT_API_KEY : getenv('YANDEX_SPEECHKIT_API_KEY');
if (empty($apiKey)) {
...
$lang = (defined('YANDEX_STT_LANG') ? (string) YANDEX_STT_LANG : getenv('YANDEX_STT_LANG')) ?: 'ru-RU';
