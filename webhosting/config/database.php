...
// Локальный конфиг для webhosting (скопируйте local.example.php в local.php и заполните)
if (file_exists(__DIR__ . '/local.php')) {
    require_once __DIR__ . '/local.php';
}

// Настройки из local.php, переменных окружения (Docker) или значения по умолчанию
if (!defined('DB_HOST')) {
