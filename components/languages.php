...
<script type="application/json" id="languages-list-<?php echo htmlspecialchars($paramName); ?>-data"><?php echo json_encode($languagesList, JSON_UNESCAPED_UNICODE); ?></script>
<div class="languages-component" data-param-name="<?php echo htmlspecialchars($paramName); ?>" data-languages-src="#languages-list-<?php echo htmlspecialchars($paramName); ?>-data">
