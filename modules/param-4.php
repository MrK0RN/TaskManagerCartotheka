    ...
    <div class="structured-fields">
        <div class="field-row">
            <div class="field-group">
                ...
                <input type="text" name="param_4_profession" id="param_4_profession" value="<?php echo htmlspecialchars($structured['profession'] ?? ''); ?>" placeholder="Профессия" class="profession-input" data-autocomplete data-autocomplete-type="profession">
            </div>
            <div class="field-group">
                <label>Должность:</label>
                <input type="text" name="param_4_position" id="param_4_position" value="<?php echo htmlspecialchars($structured['position'] ?? ''); ?>" placeholder="Должность">
            </div>
            <div class="field-group">
                <label>Отрасль:</label>
                <select name="param_4_industry" id="param_4_industry">
        ...
        <div class="field-row">
            <div class="field-group">
                ...
                <input type="number" name="param_4_total_experience" id="param_4_total_experience" value="<?php echo htmlspecialchars($structured['total_experience'] ?? ''); ?>" placeholder="0" min="0" max="100">
            </div>
            <div class="field-group">
                <label>Стаж по специальности (лет):</label>
                <input type="number" name="param_4_specialty_experience" id="param_4_specialty_experience" value="<?php echo htmlspecialchars($structured['specialty_experience'] ?? ''); ?>" placeholder="0" min="0" max="100">
            </div>
        </div>
    </div>
    
    <label for="param_4_free_text" style="margin-top: 15px;">Описание карьерной траектории:</label>
    <textarea name="param_4_free_text" id="param_4_free_text" class="large"><?php echo htmlspecialchars($freeText); ?></textarea>
</div>
