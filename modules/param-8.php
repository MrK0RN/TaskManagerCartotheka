...
<div class="form-group">
    ...
    <div class="structured-fields">
        <div class="field-row">
            <div class="field-group">
                <label>
                    <input type="checkbox" name="param_8_has_patents" value="1" <?php echo (isset($structured['has_patents']) && $structured['has_patents']) ? 'checked' : ''; ?>>
                    Есть патенты/авторские права
                </label>
            </div>
            <div class="field-group">
                <label>
                    <input type="checkbox" name="param_8_has_creative_works" value="1" <?php echo (isset($structured['has_creative_works']) && $structured['has_creative_works']) ? 'checked' : ''; ?>>
                    Есть творческие работы
                </label>
            </div>
            <div class="field-group">
                <label>
                    <input type="checkbox" name="param_8_teaches" value="1" <?php echo (isset($structured['teaches']) && $structured['teaches']) ? 'checked' : ''; ?>>
                    Преподаёт/обучает
                </label>
            </div>
        </div>
    ...
    <textarea name="param_8_free_text" id="param_8_free_text" class="large"><?php echo htmlspecialchars($freeText); ?></textarea>
</div>
