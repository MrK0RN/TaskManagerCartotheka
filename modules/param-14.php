...
<div class="form-group">
    ...
    <div class="structured-fields">
        <div class="field-row">
            <div class="field-group">
                ...
                <select name="param_14_self_esteem" id="param_14_self_esteem">
            ...
            <div class="field-group">
                ...
                <select name="param_14_relationship_esteem" id="param_14_relationship_esteem">
                    <option value="">-- Выберите --</option>
            ...
            <div class="field-group">
                ...
                <select name="param_14_work_esteem" id="param_14_work_esteem">
                    <option value="">-- Выберите --</option>
        ...
        <div class="field-row">
            <div class="field-group">
                ...
                <select name="param_14_self_efficacy" id="param_14_self_efficacy">
                    <option value="">-- Выберите --</option>
            ...
            <div class="field-group">
                ...
                <select name="param_14_self_criticism" id="param_14_self_criticism">
                    <option value="">-- Выберите --</option>
    ...
    <textarea name="param_14_free_text" id="param_14_free_text" class="large"><?php echo htmlspecialchars($freeText); ?></textarea>
</div>
